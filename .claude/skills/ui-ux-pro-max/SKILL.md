...
The search script lives inside this skill's own directory at `.claude/skills/ui-ux-pro-max/` in the project root. Run the commands below from the project root:
